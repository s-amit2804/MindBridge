...
const roles = [
  { key: 'user', label: 'User', description: 'I need support' },
  { key: 'peer_mentor', label: 'Peer Mentor', description: 'I want to help others' },
  { key: 'professional', label: 'Professional', description: 'Licensed counselor' },
  { key: 'ngo', label: 'NGO', description: 'Organization partner' },
];
      ...
      >
        <GlassPanel className="p-8">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-xl font-bold font-serif italic text-white">NeuraLyn<span className="text-gold">.</span></h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-white/60">I am a...</label>
                ...
                {roles.map((r) => (
                  <motion.button
                    ...
                    className={`p-3 rounded-xl text-left transition-all duration-300 cursor-pointer
                      ${role === r.key
                        ? 'bg-gold/15 border border-gold/30 shadow-[0_0_12px_rgba(167,139,113,0.15)]'
                        : 'bg-white/[0.03] border border-white/[0.08] hover:bg-white/[0.05]'
                      }`}
                  >
                    <p className={`text-xs font-semibold ${role === r.key ? 'text-gold' : 'text-white/60'}`}>
                      {r.label}
                    </p>
